import { Award, CalendarCheck, ExternalLink, Trash2 } from "lucide-react";
...
import { KAZANIM_TIPLERI } from "@/lib/ogrenci/kazanim-kurallar";
import { tarihYaz } from "@/lib/tarih";

/**
 * Öğrenci profilinin iki ekranda da aynı görünen bölümleri.
 *
 * Öğrencinin kendi profili (`/panel/profil`) ile danışman/koordinatör/
 * yöneticinin gördüğü detay (`/panel/ogrenciler/[id]`) aynı bileşenleri
 * kullanır: iki ekran ayrı ayrı yazılsaydı birine eklenen bir alan diğerinde
 * sessizce eksik kalırdı. Fark yalnızca DÜZENLEME haklarındadır — silme formu
 * ilgili eylem verilmediğinde hiç basılmaz.
 */
 ...
 *
 * Boş türler de başlıklarıyla görünür: danışman "bu öğrenci ürün girmemiş" ile
