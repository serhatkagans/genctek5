...
import { envanterHazirMi } from "@/lib/envanter/kurallar";
import { ENVANTERLER, SONUC_CERCEVESI } from "@/lib/envanter/tanimlar";
import { tarihYaz } from "@/lib/tarih";

export const dynamic = "force-dynamic";

/**
 * Algoritmam — envanter listesi (E).
 *
...
export default async function AlgoritmamSayfasi() {
  ...
  const hazirlar = ENVANTERLER.filter(envanterHazirMi);
  ...
  return (
    <div className="space-y-6">
      ...
      <BilgiKutusu>
        {SONUC_CERCEVESI}{" "}
        <strong>Cevapların ve sonuçların yalnızca sana görünür</strong> —
        danışman öğretmenin, il koordinatörün ve merkez hiçbir ekranda göremez.
      </BilgiKutusu>
